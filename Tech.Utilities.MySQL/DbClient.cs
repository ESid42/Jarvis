...
namespace Jarvis.Utilities.MySQL
{
    public class DbClient : DbClientBase
    {
        ...
        public string DatabaseName => Settings?.DatabaseName.ToLower() ?? string.Empty;
        public string ConnectionString => Settings?.ConnectionString ?? string.Empty;
